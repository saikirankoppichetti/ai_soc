...
This project is maintained by Sai Kiran Koppichetti. For technical inquiries, dataset issues, or collaboration requests, please open an issue on GitHub or reach out via the contact details below.
...
**About the Developer:**
Sai Kiran is an AI/ML Engineer with over 5 years of experience across machine learning, data science, and analytics. He specializes in building retrieval systems and applied LLM pipelines, including end-to-end RAG and agentic workflows. With a professional background in healthcare and financial services NLP, he focuses on developing high-trust models and evaluation frameworks for regulated domains.