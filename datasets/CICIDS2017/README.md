...
This repository is maintained by Sai Kiran Koppichetti, an AI/ML Engineer with over 5 years of experience in machine learning, data science, and analytics. Sai Kiran specializes in building end-to-end RAG and agentic pipelines, as well as gradient-boosted risk models. He ensures the technical integrity and continued utility of this dataset for the AI-SOC project.
...
Maintained by Sai Kiran Koppichetti for the AI-SOC Project
