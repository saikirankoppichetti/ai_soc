...
This project is maintained by Sai Kiran Koppichetti, an AI/ML Engineer specializing in retrieval systems and applied LLM work within regulated domains. With over 5 years of experience across machine learning and data science, he focuses on building end-to-end RAG and agentic pipelines - including ingestion, chunking, embedding, and evaluation - to ensure trustworthy outputs in healthcare and financial services environments.
